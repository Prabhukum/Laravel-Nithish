                    ...
                    <div class="row">
                        ...
                        <div class="col-4 align-self-center " style="margin-left: -15px">
                            <div class="text-center">
                                ...
                                <div class="form-page mt-5  px-4">

                                    <input class="col-md-12 form-control"  placeholder="Enter Code" id="otp" name="otp" type="text"/>

                                </div>
                            </div>
                            <span class=" px-4" style="font-size:13px">If your number is incorrect please reach out to </span><br>
                                <a href=""> <strong> <span class=" px-4" style="font-size:13px">itsupport@acrabrokerlinks.com</span></strong></a>
