    ...
    <div class="container padding-bottom-3x mb-2 mt-5">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            ...
            ?>
            <form class="card mt-4" accept="<?php echo e(route('forgot.password.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
<?php /**PATH D:\Laravel\excel\resources\views/auth/forgotPassword.blade.php ENDPATH**/ ?>