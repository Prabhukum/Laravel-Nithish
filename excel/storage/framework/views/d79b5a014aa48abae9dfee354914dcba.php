    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#country').on('change', function () {
                ...
                $('#state').html('');
                $.ajax({
                    url: '<?php echo e(route('states')); ?>?country_id='+countryId,
                    type: 'get',
            ...
            $('#state').on('change', function () {
                ...
                $('#city').html('');
                $.ajax({
                    url: '<?php echo e(route('cities')); ?>?state_id='+stateId,
                    type: 'get',
                    success: function (res) {
                        $('#city').html('<option value="">Select City</option>');
                        $.each(res, function (key, value) {
...
<?php /**PATH D:\Laravel\excel\resources\views/registration.blade.php ENDPATH**/ ?>