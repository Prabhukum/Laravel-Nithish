            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 mt-sm-5 mt-md-0 align-self-center">
                    ...
                    <div class="form-button mx-4 col-md-11 mt-4">
                        <button class="btn btn-primary text-white " style="background: #213E97 0% 0% no-repeat padding-box; width: 100%; height: 48px; border-radius: 5px;"><a href="/second" style="color:white"><b>NEXT</a></b></button>
                    </div>
                </div>
            </div>
        </div>
